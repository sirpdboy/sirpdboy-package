...
local e=luci.http
local a,t,e
a=Map("dns-to",translate("dns-to"),translate("ddnsto是支持http2的快速远程路由工具。</br>你需要先到 https://www.ddnsto.com/app/#/weixinlogin注册，然后在本插件内填入Token，再登录 https://www.ddnsto.com/app/#/weixinlogin设置穿透。"))
a.template="dns-to/index"
t=a:section(TypedSection,"global",translate("Running Status"))
t.anonymous=true
e=t:option(DummyValue,"_status",translate("Running Status"))
e.template="dns-to/dvalue"
...
e.password=true
e.rmempty=false
if nixio.fs.access("/etc/config/dns-to")then
