...
define Package/luci-app-wizard/install
	...
	$(INSTALL_BIN) ./files/root/etc/uci-defaults/40_luci-app-wizard $(1)/etc/uci-defaults/40_luci-app-wizard
	$(INSTALL_BIN) ./files/uci.defaults $(1)/etc/uci-defaults/99-uci-defaults
endef
